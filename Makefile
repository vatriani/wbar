CC = gcc
CFLAGS = -Os -fdata-sections -ffunction-sections -pedantic-errors -std=gnu11 -march=native -mtune=native -Wall -Wextra -fstack-protector-strong -fPIE -flto $(shell pkg-config --cflags wayland-client cairo pango pangocairo xkbcommon)
...
SRC = src/basics.c src/buffer.c src/wayland-core.c src/window.c src/main.c src/wlr-layer-shell-unstable-v1.c src/xdg-shell.c
