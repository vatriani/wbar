...
SRC = src/basics.c src/vector.c src/sys-vitals.c src/buffer.c src/hyprland.c src/wayland-core.c src/main.c src/wlr-layer-shell-unstable-v1.c src/xdg-shell.c
